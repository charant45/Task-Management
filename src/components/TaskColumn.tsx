  ...
  return (
    <div className="flex flex-col w-full max-md:w-full">
      <div className="flex overflow-hidden flex-col items-center pb-6 w-full bg-white rounded-xl border border-solid border-zinc-100 shadow-[24px_24px_80px_rgba(0,0,0,0.01)]">
        <h2
          className={`flex-1 shrink gap-2.5 self-stretch px-6 py-3 max-w-full text-base font-semibold text-center uppercase whitespace-nowrap bg-${color} border-b border-zinc-100 w-[312px] max-md:px-5 rounded-t-xl`}
        >
          {title}
        </h2>
